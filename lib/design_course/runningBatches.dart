...
class RunningBatches extends StatefulWidget {
  @override
  _RunningBatchesState createState() => _RunningBatchesState();
}

class _RunningBatchesState extends State<RunningBatches> {
  ...
  Future<List> getHttp()async{
    ...
    Response response = await Dio().get("https://www.jeevandangwalior.com/HanuSir/runningBatches.php?teacherMobile=${mobile}");
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                      padding: const EdgeInsets.only(left:10.0,right:10),
                                      width:MediaQuery.of(context).size.width*.8,
                                      child: Text("Topic: "+batch["Topic"],style:TextStyle(fontSize: 16))
                                  ),
                                  Container(
                                      padding: const EdgeInsets.only(left:10.0,right:10),
                                      width:MediaQuery.of(context).size.width*.8,
