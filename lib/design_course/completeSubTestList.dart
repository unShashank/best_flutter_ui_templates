...
class CompleteSubTestList extends StatefulWidget {
  var testId='',teacherId='';

  CompleteSubTestList(testId,teacherId){
    this.testId=testId;
    this.teacherId=teacherId;
  }

  @override
  _CompleteSubTestListState createState() => _CompleteSubTestListState(testId,teacherId);
}

class _CompleteSubTestListState extends State<CompleteSubTestList> {
  CategoryType categoryType = CategoryType.ui;
  int _current = 0;
String testId='',teacherId='';
  _CompleteSubTestListState(String testId,String teacherId){
    this.testId=testId;
    this.teacherId=teacherId;
  }
  /* List imgList = [
  ...
  String getInterstitialAdUnitId() {
    if (Platform.isIOS) {
      ...
      return global.admobIntertitialId1;
    }
    return null;
  }
  ...
  Future<List> getHttp() async {
    try {
      Response response = await Dio().get("https://www.jeevandangwalior.com/HanuSir/getSubTest.php?test_id="+testId);
                          ...
                          InkWell(
                            child: Card(
                              ...
                              child: Row(children: <Widget>[
                                Image.asset("assets/images/testpad.png"),
                                SizedBox(width: 20,),
                                Text(chapter['subtest'])
                              ],),
                            ),
                            onTap: (){
                              Navigator.push<dynamic>(
                                ...
                                MaterialPageRoute<dynamic>(
                                  builder: (BuildContext context) => CompleteTestList(testId,teacherId,chapter["Id"]),
                                ),
                              );
                            },
                          ),
