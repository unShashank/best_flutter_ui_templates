...
class VideoList extends StatefulWidget {
  ...
  VideoList(chapterId,subjectId){
    this.subjectId=subjectId;
    this.chapterId=chapterId;
  }

  @override
  _VideoListState createState() => _VideoListState(subjectId,chapterId);
}
...
String subjectId='',chapterId='';
  _VideoListState(String subjectId,String chapterId){
    this.subjectId=subjectId;
    this.chapterId=chapterId;
  }
  /* List imgList = [
  ...
  Future<List> getHttp() async {
    try {
      Response response = await Dio().get("https://www.jeevandangwalior.com/HanuSir/getVideos.php?subjectId="+subjectId+"&chapterId="+chapterId);
                            ...
                            onTap: (){
                              Navigator.push<dynamic>(
                                ...
                                MaterialPageRoute<dynamic>(
                                  builder: (BuildContext context) => YoutubeVideoPlayer(chapter["Link"]),
                                ),
                              );
                            },
                          ),
