...
class VideoChapters extends StatefulWidget {
  var subjectId='';
  VideoChapters(subjectId){
    this.subjectId=subjectId;
  }

  @override
  _VideoChaptersState createState() => _VideoChaptersState(subjectId);
}

class _VideoChaptersState extends State<VideoChapters> {
  CategoryType categoryType = CategoryType.ui;
  int _current = 0;
String subjectId='';
  _VideoChaptersState(String subjectId){
    this.subjectId=subjectId;
  }
  /* List imgList = [
                            ...
                            onTap: (){
                              Navigator.push<dynamic>(
                                ...
                                MaterialPageRoute<dynamic>(
                                  builder: (BuildContext context) => VideoList(chapter['Id'],subjectId),
                                ),
                              );
                            },
                          ),
