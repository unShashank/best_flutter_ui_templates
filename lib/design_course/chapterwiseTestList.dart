...
class CapterwiseTestList extends StatefulWidget {
  var chapterId,subjectId;
  CapterwiseTestList(this.chapterId,this.subjectId);
  @override
  _CapterwiseTestListState createState() => _CapterwiseTestListState(this.chapterId,this.subjectId);
}

class _CapterwiseTestListState extends State<CapterwiseTestList> {
  CategoryType categoryType = CategoryType.ui;

  var chapterId,subjectId;
  _CapterwiseTestListState(this.chapterId,this.subjectId);
  int _current = 0;
  /* List imgList = [
  ...
  Future<List> getHttp()async{
    ...
    Response response = await Dio().get("http://jeevandangwalior.com/HanuSir/getChapterwiseTest.php?subjectId=$subjectId&chapterId=$chapterId");
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                          ...
                                          ButtonTheme(minWidth:60,height:30,child: RaisedButton(child: Text("Start",style: TextStyle(color: Colors.white),),onPressed: (){
                                            Navigator.push(
                                              ...
                                              MaterialPageRoute<dynamic>(
                                                builder: (BuildContext context) => Test(batch["Question_id"],batch["timing"]),
                                              ),
                                            );
                                          },))
                                        ],
                                  ...
                                  Container(
                                      padding: const EdgeInsets.only(left:10.0,right:10),
                                      width:MediaQuery.of(context).size.width*.8,
                                      child: Text("Time: "+batch["timing"]+" minutes",style:TextStyle(fontSize: 16))
                                  ),

                                  Container(
                                      padding: const EdgeInsets.only(left:10.0,right:10),
                                      width:MediaQuery.of(context).size.width*.8,
                                      child: Text("Status: "+batch["pay_status"],style:TextStyle(fontSize: 16))
                                  ),
                                  /*
                                  Container(
                                      padding: const EdgeInsets.only(left:10.0,right:10),
