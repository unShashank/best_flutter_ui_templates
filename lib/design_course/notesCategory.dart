...
import 'package:best_flutter_ui_templates/design_course/videoChapters.dart';
...
class _NotesCategoryState extends State<NotesCategory> {
  ...
  int _current = 0;
  String subjectId='';
  _ChaptersState(String subjectId){
                    ...
                    InkWell(
                      ...
                      onTap: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute<dynamic>(
                            builder: (BuildContext context) => NotesChapters(chapter["subjectId"]),
                          ),
                        );
                      },
                    ),
