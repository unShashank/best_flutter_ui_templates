...
class YoutubeVideoPlayer extends StatefulWidget {
  ...
  @override
  _YoutubeVideoPlayerState createState() => _YoutubeVideoPlayerState(videoId);
}
...
var _abc=TextEditingController();
...
String videoId;
  ...
  _YoutubeVideoPlayerState(this.videoId);
  ...
  void initState() {
    if(videoId.isEmpty)
      videoId="iLnmTe5Q2Qw";
print("ddhkdhd"+videoId);

setState(() {
  _controller = YoutubePlayerController(
    initialVideoId: this.videoId.trim(),
