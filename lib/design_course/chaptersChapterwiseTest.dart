...
import 'chapterwiseTestList.dart';
import 'design_course_app_theme.dart';
import 'globals.dart' as global;
import 'home_design_course.dart';
import 'notesCategory.dart';
class ChaptersChapterWiseTest extends StatefulWidget {
  var subjectId='';
  ChaptersChapterWiseTest(subjectId){
    this.subjectId=subjectId;
  }

  @override
  _ChaptersChapterWiseTestState createState() => _ChaptersChapterWiseTestState(subjectId);
}

class _ChaptersChapterWiseTestState extends State<ChaptersChapterWiseTest> {
  ...
  var clickedItem;
  _ChaptersChapterWiseTestState(String subjectId){
    this.subjectId=subjectId;
  }
  /* List imgList = [
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          builder: (BuildContext context) =>
                              CapterwiseTestList(chapter['Id'], subjectId),
                          ),
                          );
                          }
                          ...
                          MaterialPageRoute<dynamic>(
                          builder: (BuildContext context) =>
                          ChapterSheets(chapter['Id'], subjectId),
                          ),
                          );
                          }
                          },
